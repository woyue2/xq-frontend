/**
 * [POS] src/pages/MyQuestionsPage.tsx
 *   所属：pages 层 | 角色：我的提问列表页，路由 `/my-questions`，学生可见
 *   兄弟：MyAnswersPage.tsx / MyLikesPage.tsx / MyFavoritesPage.tsx
 *
 * [INPUT]
...
export function MyQuestionsPage() {
  ...
  const canDeleteQuestion = (question: any) => {
    ...
    const answers =
      ...
      (question.stats && typeof question.stats.answers === 'number' ? question.stats.answers : 0);
      ...
      <div className="bg-white rounded-3xl p-6 mb-4 shadow-sm">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div
            ...
            onClick={() => navigate(ROUTES.myQuestionsStatus('approved'))}
          >
          ...
          <div
            ...
            className="cursor-pointer hover:bg-gray-50 rounded-xl p-2 transition flex flex-col justify-center items-center h-full"
            onClick={() => navigate(ROUTES.myQuestionsStatus('pending'))}
          >
