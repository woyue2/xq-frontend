/**
 * [POS] src/pages/DiagnosticPage.tsx
 *   所属：pages 层 | 角色：API 诊断测试页，路由 `/diagnostic`，教师/开发调试
 *   兄弟：TestApiPage.tsx
 *
 * [INPUT]
 *   - react                        → useEffect
 ...
 *   - @/lib/test-runner            → runDiagnosticTests
 *
 * [OUTPUT]
 *   - DiagnosticPage（页面组件）
 *
...
export function DiagnosticPage() {
  ...
  const avgDuration =
    results.reduce((acc, curr) => acc + (curr.duration || 0), 0) / (passed + failed) || 0;
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <Button
            onClick={handleStart}
            disabled={isRunning}
            className="bg-morandi-5 hover:bg-morandi-5/90"
          >
