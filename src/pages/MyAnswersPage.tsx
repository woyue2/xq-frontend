/**
 * [POS] src/pages/MyAnswersPage.tsx
 *   所属：pages 层 | 角色：我的回答列表页，路由 `/my-answers`，教师可见
 *   兄弟：MyQuestionsPage.tsx / MyLikesPage.tsx / MyFavoritesPage.tsx
 *
 * [INPUT]
 *   - lucide-react        → MessageSquare / ThumbsUp / ChevronRight
 *   - @/components/ui/*  → Badge
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {myAnswers.map((answer) => (
            <div
              key={answer.id}
              onClick={() => navigate(ROUTES.question(answer.questionId))}
